export const strings = {
    algorandGreenhouseRound1Completed: 'Algorand Greenhuse Hack Round #1 completed',
    ...
    mission: 'Mission',
    newCreatorsProjects: 'More creator\'s signed up with new projects',
    newNFTs: 'New NFTs designed',
    openSourceSetUp: 'Open source organisation set up on GitHub (website + dapp)',
    ourMission: 'Our Mission',
    pilotDone: 'First pilot project fully funded and tracked',
    pilotProject: 'Signed up first creator for pilot project',
    ...
    webAppV2: 'Web app + dapp to include creator\'s account, project land allocation, darft project tracker',
