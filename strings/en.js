export const strings = {
    ...
    whatIsTerragrids2: 'Participants in the Terragrids ecosystem (called citizens) can buy digital crypto tokens (NFTs) that have a 1:1 link with unique solar PV cells in the real world. Participants’ tokens make up virtual solar PV systems in the Terragrids greenverse. These virtual solar PV systems are linked to real solar PV systems installed on the roofs of real people that live in fuel poverty.',
    whatIsTerragrids3: 'Terragrids citizens can own, explore, use and trade their tokens to help govern and expand a virtual electricity grid that power towns and villages in the greenverse; most importantly, they help build and expand a real electricity generation grid, which will reduce fuel poverty, help meet global carbon reduction targets, and ensure a better future for the planet.'
}
