export const strings = {
    ...
    decentralizedContent: 'Terragrids is decentralized from inception. The whitepaper is a collaborative document where anyone can comment and propose new ideas. The website and the DApp are entirely open source, so that any developers across the globe can contribute to making Terragrids a better platform. Terragrids citizens can acquire DAO governance rights, and they can participate, discuss and vote for internal decisions.',
    ...
    whatIsTerragrids1: 'Terragrids is an decentralised crowdfunding platform whose goal is to empower communities and individuals to take back ownership of what nature gives them for free: energy.',
    whatIsTerragrids2: 'Terragrids provides a funding platform for renewable energy projects. The platform runs a small metaverse, where project creators are allocated part of the metaverse estate, and other participants can explore, build and develop sustainable towns on the creators\' land.',
    whatIsTerragrids3: 'Players buy and own NFTs to develop the Terragrids world on the virtual map, developing towns on a creator\'s land and becoming their project backers. The revenues from the purchase of each NFT will be administered in the Terragrids treasury Algorand wallet and allocated to each creator\'s account to fund the the butget goal set for their renewable energy project.',
    whatIsTerragrids4: 'NFTs will give players governance rights in the management of the Terragrids metaverse, gradually developing Terragrids into a DAO.',
    whatIsTerragrids5: 'Anyone can become a Terragrids citizen. They just need an Algorand Wallet and a passion for sustainability and decentralisation. Terragrids citizens can own, explore, use and trade their tokens to help govern and expand virtual towns and villages in the greenverse; most importantly, they help build and expand a real electricity generation grid, which will reduce fuel poverty, help meet global carbon reduction targets, and ensure a better future for the planet.',
