export const strings = {
    ...
    webAppV3: 'Web app + dapp to include full creator\'s project tracker, DAO governance tools, internal secondary marketplace for NFTs',
    website1_0: 'Website 1.0',
    website2_0: 'Website 2.0',
    whatIsTerragrids1: 'Terragrids is a decentralised crowdfunding platform whose goal is to empower communities and individuals to take back ownership of what nature gives them for free: energy.',
    whatIsTerragrids2: 'Terragrids provides a funding platform for renewable energy projects. The platform runs a small metaverse, where project Creators are allocated part of the metaverse estate, and other participants - called Backers - can explore, build and develop sustainable towns on the Creators\' land.',
    whatIsTerragrids3: 'Backers buy NFTs and develop towns on Creators\' land in the virtual map. The revenues from the purchase of each NFT will be administered by Terragrids in a treasury Algorand wallet and will be allocated to each Creator\'s account to fund the budget goal set for their renewable energy project.',
    whatIsTerragrids4: 'NFTs will give Backers governance rights in the management of the Terragrids metaverse, gradually developing Terragrids into a Decentralised Autonomous Organisation (DAO).',
    whatIsTerragrids5: 'Anyone can become a Creator or a Backer on Terragrids. They just need an Algorand Wallet and a passion for sustainability and decentralisation. Creators can set up a project brief, a budget goal, and associate it to an area of land on Terragrids open for crowdfunding. Backers can buy, collect and trade their NFTs to expand virtual towns and villages in the greenverse; doing so, they fund real renewable energy projects, which will help meet global carbon reduction targets and ensure a better future for the planet.',
